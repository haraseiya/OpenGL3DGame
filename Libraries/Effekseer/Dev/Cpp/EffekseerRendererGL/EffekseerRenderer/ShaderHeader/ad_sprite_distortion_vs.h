...
static const char ad_sprite_distortion_vs_gl2[] = R"(#version 120
...
static const char ad_sprite_distortion_vs_gl3[] = R"(#version 330
#ifdef GL_ARB_shading_language_420pack
#extension GL_ARB_shading_language_420pack : require
#endif
...
static const char ad_sprite_distortion_vs_gles2[] = R"(
...
static const char ad_sprite_distortion_vs_gles3[] = R"(#version 300 es
...
void main()
{
    ...
    static const char* get_ad_sprite_distortion_vs (EffekseerRendererGL::OpenGLDeviceType deviceType)
    {
    #if !defined(__EMSCRIPTEN__)
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL3)
            return ad_sprite_distortion_vs_gl3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGL2)
            return ad_sprite_distortion_vs_gl2;
    #endif
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES3)
            return ad_sprite_distortion_vs_gles3;
        if (deviceType == EffekseerRendererGL::OpenGLDeviceType::OpenGLES2)
            return ad_sprite_distortion_vs_gles2;
        return nullptr;
    }
